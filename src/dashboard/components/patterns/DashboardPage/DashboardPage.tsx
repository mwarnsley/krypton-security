 ...
 */
export function showSimulatedThreatEventToast(): string | number {
...
function normalizeAlert(value: unknown, alertIndex: number): SecurityAlert | undefined {
  ...
  const targetProcessId =
    value.targetProcessId === null || typeof value.targetProcessId === 'number'
  ...
  if (
    ...
    (targetProcessId !== null &&
      (typeof targetProcessId !== 'number' ||
        ...
        targetProcessId <= 0)) ||
    (targetProcessId === null && value.attribution !== 'unattributed')
  ) {
    return undefined;
  }
 ...
 */
export function normalizeTelemetryPayload(payload: unknown): TelemetryState {
